<template>
  <main>
    <page-section>
      <heading variant="block">Code of Conduct</heading>
      <heading level="6" tag="h3">Last updated: July 11, 2019</heading>
      ...
      <paragraph>
        To prevent conflict and to create a safe and engaging atmosphere; all attendees, sponsors,
        speakers, vendors, volunteers, staff and organisers shall:
      </paragraph>
      ...
      <heading level="4" tag="h3">Be respectful</heading>
      <paragraph>
        Poor manners and attitude are never an excuse. Always treat others with the most utmost
        respect, and be welcoming to everyone. Do not speak ill of others in any environment or
        situation.
      </paragraph>

      <heading level="4" tag="h3">Own responsibility</heading>
      <paragraph>
      ...
      <list bullet>
        <list-item>
          Sharing or engaging in content including but not limited to verbal, written, image and
          videos that are deemed offensive related to gender, gender identity and expression, sexual
      ...
      <list bullet>
        <list-item>
          ‘Reverse’ -isms, including ‘reverse racism,’ ‘reverse sexism,’ and ‘cisphobia’ (because
      ...
      <heading level="3" tag="h2">Diversity Policy</heading>
      <paragraph>
      ...
      <paragraph>
        ...
        it by contacting any of the following:
      </paragraph>
      <list bullet>
        <list-item>
          Blake Newman, +447456625779, blake.newman@vuejs.london
        </list-item>
        <list-item>
          Rui Posse, rui.posse@vuejs.london
        </list-item>
      </list>
      <paragraph>
        All reports will be handled with discretion - we will not disclose any information that can
        be used to identify you without prior consent. In your report please include:
      </paragraph>
      <list bullet>
        <list-item>
        ...
        <list-item>
          Names (real, nicknames, or pseudonyms) of any individuals involved, if they are known to
          you.
        </list-item>
        <list-item>
      ...
      <paragraph>
        After filing a report, a representative will contact you personally, review the incident,
        follow up with any additional questions, and make a decision as to how to respond. If the
        person who is harassing you is part of the response team, they will recuse themselves from
        handling your incident. If the complaint originates from a member of the response team, it
        will be handled by a different member of the response team. We will respect confidentiality
      ...
      <paragraph>
        If you have any questions about the code of conduct, please contact us at team@vuejs.london
      </paragraph>
    </page-section>
  </main>
</template>
