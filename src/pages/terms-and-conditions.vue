<template>
  <main>
    <page-section>
      <heading variant="block">Terms and conditions</heading>
      <heading level="3">Last updated: June 08, 2019</heading>
      <paragraph>
        Please read these Terms and Conditions ("Terms", "Terms and Conditions") carefully before
        using the https://vuejs.london website (the "Service") operated by Vue.js Limited ("us",
        "we", or "our").
      </paragraph>
      <paragraph>
      ...
      <heading level="2">Purchases</heading>
      <paragraph>
        You are encouraged to familiarise yourself with your rights contained within the Sale of
        Goods Act 1979, Unfair Contract Terms Act 1977 and the Unfair Terms in Consumer Contracts
        Regulations 1999.
      </paragraph>
      <paragraph>
      ...
      <paragraph>
        ...
        supply to us is true, correct and complete. You expressly agree that Vue.js Limited is not
        responsible for any loss or damage arising from the submission of false or inaccurate
        information.
      </paragraph>
      <paragraph>
      ...
      <paragraph>
        ...
        price of the product or service, error in your order or other reasons. You expressly agree
        that Vue.js Limited cannot accept any liability for loss or damage arising out of such
        cancellation.
      </paragraph>
      <paragraph>
      ...
      <heading level="2">Availability, Errors and Inaccuracies</heading>
      <paragraph>
        ...
        unavailable, and we may experience delays in updating information on the Service and in our
        advertising on other web sites. You expressly agree that any such offer of a product or
      ...
      <paragraph>
        ...
        without prior notice. Section "Availability, Errors and Inaccuracies" is without prejudice
        to existing statutory rights.
      </paragraph>
      <heading level="2">Links To Other Web Sites</heading>
      <paragraph>
        Our Service may contain links to third-party web sites or services that are not owned or
        controlled by Vue.js Limited.
      </paragraph>
      <paragraph>
        Vue.js Limited has no control over, and assumes no responsibility for, the content, privacy
        policies, or practices of any third party web sites or services. You further acknowledge and
        agree that Vue.js Limited shall not be responsible or liable, directly or indirectly, for
      ...
      <paragraph>Upon termination, your right to use the Service will immediately cease.</paragraph>
      <paragraph>
      ...
      <paragraph>
        You agree to defend, indemnify and hold harmless Vue.js Limited and its licensee and
      ...
      <paragraph>
        In no event shall Vue.js Limited, nor its directors, employees, partners, agents, suppliers,
      ...
      <paragraph>
        Vue.js Limited its subsidiaries, affiliates, and its licensors do not warrant that a) the
      ...
      <paragraph>
        ...
        these terms, under no circumstances will Vue.js Limited ever be liable to you or any other
        person for any indirect, incidental, consequential, special, punitive or exemplary loss or
        damage arising from, connected with, or relating to your use of the Service, these Terms,
        the subject matter of these Terms, the termination of these Terms or otherwise, including
        but not limited to personal injury, loss of data, business, markets, savings, income,
        profits, use, production, reputation or goodwill, anticipated or otherwise, or economic
        loss, under any theory of liability (whether in contract, tort, strict liability or any
        other theory or law or equity), regardless of any negligence or other fault or wrongdoing
        (including without limitation gross negligence and fundamental breach) by Vue.js Limited or
        any person for whom Vue.js Limited is responsible, and even if Vue.js Limited has been
      ...
      <heading level="2">Privacy Policy and Cookie Policy</heading>
      <paragraph>
        Please refer to our Privacy Policy and Cookies Policy. You agree that they constitute part
        of these terms. You must read our Privacy Policy and Cookies Policy before you use the
        Service.
      </paragraph>
