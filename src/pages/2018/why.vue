<template>
  <div class="container">
    <div class="section post-section">
      <heading>Why Vue.js London</heading>
      <p>Discover what makes Vue.js London a conference worth attending.</p>
    </div>
    ...
    <div class="container__inner">
      ...
      <p>
        ...
        experts from all aspects of the web community! Version 3 of Vue is under rapid development,
        so Vue.js London is the perfect conference to attend to ensure you are following the latest
        changes in the community. Vue.js London 2019 topics will be focused on advancing your
        knowledge in core areas; ensuring you are ready to use Vue 3 and prepared and aware of
        changes to expect in the surrounding community.
      </p>
      <p>
        Talks and speakers will be announced in due course! CFP is open for lightning/full length
        talks and workshops, apply now.
      </p>
    </div>
    ...
    <div class="container__inner">
      <heading level="2">First Time</heading>
      <p>
        Don't worry we know it can be daunting - we have got this covered. Last year we opened a
        <strong>Conference Buddy booth</strong> to allow you to connect with others similar
        situation. We will be putting even more effort this year to make sure everyones experience
        is top notch!
      </p>
    </div>
    <div class="container__inner">
    ...
    <div class="container__inner">
      ...
      <p>
        ...
        <strong>dietary requirements as possible</strong> - Pescatarian, Vegetarian, Vegan, Lactose
        Intolerance, Gluten Free, Halal and more!
      </p>
    </div>
    <div class="container__inner">
    ...
    <div class="container__inner">
      <heading level="2">Join the slack</heading>
      <p>
        If you are still undecided if this event is for you, join the Vue.js Conferences slack. You
        can discuss with others and get a feel for the event further.
      </p>
      <form-button
        tag="a"
