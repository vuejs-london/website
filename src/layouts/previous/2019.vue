<template>
  <div>
    <navbar :links="navbarLinks" title-link="/2019">
      <template #title>
        Vue.js London - 2019
      </template>
    </navbar>
  ...
  export default {
    ...
    created() {
      this.navbarLinks = [
        { to: '/', text: '2020' },
        { to: '/2018', text: '2018' },
        { to: '/2019', text: 'Gallery' },
        { to: '/2019/sponsors', text: 'Sponsors' },
        { to: '/2019/speakers', text: 'Speakers' },
        { to: '/2019/advice-lounge', text: 'Advice Lounge' },
      ]
